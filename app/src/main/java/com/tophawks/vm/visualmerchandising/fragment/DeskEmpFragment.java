...
public class DeskEmpFragment extends Fragment {
    ...
    public DeskEmpFragment() {
    }

    @Override
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        View vi = inflater.inflate(R.layout.fragment_desk_emp, container, false);
        ...
        location = (Button) vi.findViewById(R.id.button2);
        faceRecognition = (Button) vi.findViewById(R.id.button3);
        locDoneImageView = (ImageView) vi.findViewById(R.id.desk_loc_done_img);
        faceDoneImageView = (ImageView) vi.findViewById(R.id.desk_face_done_img);
        doneImageView = (ImageView) vi.findViewById(R.id.desk_status);
    ...
    private void pushAttendanceInDatabase(){
        ...
        AttendanceResponse response = new AttendanceResponse("DeskEmployee", "Present");
