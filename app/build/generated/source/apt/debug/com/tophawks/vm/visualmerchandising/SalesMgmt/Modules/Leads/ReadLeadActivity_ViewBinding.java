...
public class ReadLeadActivity_ViewBinding implements Unbinder {
  private ReadLeadActivity target;

  @UiThread
  public ReadLeadActivity_ViewBinding(ReadLeadActivity target) {
    this(target, target.getWindow().getDecorView());
  }

  @UiThread
  public ReadLeadActivity_ViewBinding(ReadLeadActivity target, View source) {
    this.target = target;
  ...
  @CallSuper
  public void unbind() {
    ReadLeadActivity target = this.target;
