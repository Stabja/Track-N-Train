...
public class UpdateAccountActivity_ViewBinding implements Unbinder {
  ...
  @UiThread
  public UpdateAccountActivity_ViewBinding(UpdateAccountActivity target) {
    this(target, target.getWindow().getDecorView());
  }

  @UiThread
  public UpdateAccountActivity_ViewBinding(UpdateAccountActivity target, View source) {
    this.target = target;
    ...
    target.update = Utils.findRequiredViewAsType(source, R.id.update_account, "field 'update'", Button.class);
  }

  @Override
  @CallSuper
  public void unbind() {
    UpdateAccountActivity target = this.target;
