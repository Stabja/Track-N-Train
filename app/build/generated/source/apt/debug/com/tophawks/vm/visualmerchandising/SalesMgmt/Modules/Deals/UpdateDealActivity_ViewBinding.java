...
public class UpdateDealActivity_ViewBinding implements Unbinder {
  private UpdateDealActivity target;

  @UiThread
  public UpdateDealActivity_ViewBinding(UpdateDealActivity target) {
    this(target, target.getWindow().getDecorView());
  }

  @UiThread
  public UpdateDealActivity_ViewBinding(UpdateDealActivity target, View source) {
    this.target = target;
    ...
    target.update = Utils.findRequiredViewAsType(source, R.id.update_deal, "field 'update'", Button.class);
  }

  @Override
  @CallSuper
  public void unbind() {
    UpdateDealActivity target = this.target;
