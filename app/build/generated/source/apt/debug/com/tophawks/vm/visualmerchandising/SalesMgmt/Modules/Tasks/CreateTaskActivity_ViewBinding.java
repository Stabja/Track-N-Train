...
public class CreateTaskActivity_ViewBinding implements Unbinder {
  ...
  @UiThread
  public CreateTaskActivity_ViewBinding(CreateTaskActivity target) {
    this(target, target.getWindow().getDecorView());
  }

  @UiThread
  public CreateTaskActivity_ViewBinding(CreateTaskActivity target, View source) {
    this.target = target;
    ...
    target.create = Utils.findRequiredViewAsType(source, R.id.create_task, "field 'create'", Button.class);
  ...
  @CallSuper
  public void unbind() {
    CreateTaskActivity target = this.target;
