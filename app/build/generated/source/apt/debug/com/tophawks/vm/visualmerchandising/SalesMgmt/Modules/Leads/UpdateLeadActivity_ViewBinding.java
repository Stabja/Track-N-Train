...
public class UpdateLeadActivity_ViewBinding implements Unbinder {
  private UpdateLeadActivity target;

  @UiThread
  public UpdateLeadActivity_ViewBinding(UpdateLeadActivity target) {
    this(target, target.getWindow().getDecorView());
  }

  @UiThread
  public UpdateLeadActivity_ViewBinding(UpdateLeadActivity target, View source) {
    this.target = target;
    ...
    target.update = Utils.findRequiredViewAsType(source, R.id.update_lead, "field 'update'", Button.class);
  }

  @Override
  @CallSuper
  public void unbind() {
    UpdateLeadActivity target = this.target;
