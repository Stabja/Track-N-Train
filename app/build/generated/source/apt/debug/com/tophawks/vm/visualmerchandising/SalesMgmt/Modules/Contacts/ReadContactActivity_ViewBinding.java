...
public class ReadContactActivity_ViewBinding implements Unbinder {
  private ReadContactActivity target;

  @UiThread
  public ReadContactActivity_ViewBinding(ReadContactActivity target) {
    this(target, target.getWindow().getDecorView());
  }

  @UiThread
  public ReadContactActivity_ViewBinding(ReadContactActivity target, View source) {
    this.target = target;
    ...
    target.tv13 = Utils.findRequiredViewAsType(source, R.id.editText12, "field 'tv13'", TextView.class);
  }

  @Override
  @CallSuper
  public void unbind() {
    ReadContactActivity target = this.target;
