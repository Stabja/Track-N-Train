...
public class CreateContactActivity_ViewBinding implements Unbinder {
  ...
  @UiThread
  public CreateContactActivity_ViewBinding(CreateContactActivity target) {
    this(target, target.getWindow().getDecorView());
  }

  @UiThread
  public CreateContactActivity_ViewBinding(CreateContactActivity target, View source) {
    this.target = target;
    ...
    target.create = Utils.findRequiredViewAsType(source, R.id.create_contact, "field 'create'", Button.class);
  }

  @Override
  @CallSuper
  public void unbind() {
    CreateContactActivity target = this.target;
