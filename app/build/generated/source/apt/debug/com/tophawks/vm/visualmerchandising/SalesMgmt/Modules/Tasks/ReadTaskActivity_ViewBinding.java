...
public class ReadTaskActivity_ViewBinding implements Unbinder {
  ...
  @UiThread
  public ReadTaskActivity_ViewBinding(ReadTaskActivity target) {
    this(target, target.getWindow().getDecorView());
  }

  @UiThread
  public ReadTaskActivity_ViewBinding(ReadTaskActivity target, View source) {
    this.target = target;
  ...
  @CallSuper
  public void unbind() {
    ReadTaskActivity target = this.target;
