...
public class ReadDealActivity_ViewBinding implements Unbinder {
  private ReadDealActivity target;

  @UiThread
  public ReadDealActivity_ViewBinding(ReadDealActivity target) {
    this(target, target.getWindow().getDecorView());
  }

  @UiThread
  public ReadDealActivity_ViewBinding(ReadDealActivity target, View source) {
    this.target = target;
  ...
  @CallSuper
  public void unbind() {
    ReadDealActivity target = this.target;
